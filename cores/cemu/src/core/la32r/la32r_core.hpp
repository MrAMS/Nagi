                ...
                default:
                    ...
                    case ST_B: {
                        ...
                        la32r_exccode exc = mmu.va_write(va, 1, (uint8_t * ) & GPR[instr._2ri12.rd],
                                                         ...
                                                         csr.get_crmd_pg(),
                                                         csr.get_asid());
                        if(trace) traces.push(std::make_tuple(va, 1, (uint8_t)GPR[instr._2ri12.rd], true));
                        if (exc.first != OK) {
                            csr.raise_trap(exc, va);
                        }
                        break;
                    ...
                    case ST_H: {
                        ...
                        la32r_exccode exc = mmu.va_write(va, 2, (uint8_t * ) & GPR[instr._2ri12.rd],
                                                         ...
                                                         csr.get_crmd_pg(),
                                                         csr.get_asid());
                        if(trace) traces.push(std::make_tuple(va, 2, (uint16_t)GPR[instr._2ri12.rd], true));
                        if (exc.first != OK) {
                            csr.raise_trap(exc, va);
                        }
                        break;
                    ...
                    case ST_W: {
                        ...
                        la32r_exccode exc = mmu.va_write(va, 4, (uint8_t * ) & GPR[instr._2ri12.rd],
                                                         ...
                                                         csr.get_crmd_pg(),
                                                         csr.get_asid());
                        if(trace) traces.push(std::make_tuple(va, 4, (uint32_t)GPR[instr._2ri12.rd], true));
                        if (exc.first != OK) {
                            csr.raise_trap(exc, va);
                        }
                        break;
